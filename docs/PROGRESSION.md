...
Version 0.2.4 classifies an item as Archipelago advancement only when it
...
GUIDs. The 0.2.4 audit resolves every GUID against the cooked gameplay maps in
...
none unlock another check in the 0.2.4 location table:
