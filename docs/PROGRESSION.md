...
Version 0.2.3 classifies an item as Archipelago advancement only when it
...
GUIDs. The 0.2.3 audit resolves every GUID against the cooked gameplay maps in
...
none unlock another check in the 0.2.3 location table:
